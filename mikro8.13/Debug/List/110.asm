...
_0x0:
	.DB  0x42,0x61,0x62,0x61,0x65,0x69,0x0,0x20
	.DB  0x41,0x6C,0x69,0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
_0x3:
; 0000 0097    {
; 0000 0098    lcd_gotoxy(5,0);
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0099    lcd_putsf("Babaei");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 009A    for(i=0;i<12;)
	CLR  R4
	CLR  R5
_0x7:
	LDI  R30,LOW(12)
...
; 0000 009C      i++;
	...
	ADIW R30,1
	RCALL SUBOPT_0x0
; 0000 009D      lcd_gotoxy(i,1);
; 0000 009E      lcd_putsf(" Ali ");
; 0000 009F      delay_ms(300);
; 0000 00A0     }
	RJMP _0x7
_0x8:
; 0000 00A1    for(i=12;i>0;)
	LDI  R30,LOW(12)
	LDI  R31,HIGH(12)
	MOVW R4,R30
_0xA:
...
; 0000 00A3      i--;
	...
	SBIW R30,1
	RCALL SUBOPT_0x0
; 0000 00A4      lcd_gotoxy(i,1);
; 0000 00A5      lcd_putsf(" Ali ");
