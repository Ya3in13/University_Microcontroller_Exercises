...
_0x0:
	...
	.DB  0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x59,0x61,0x73,0x69,0x6E,0x20,0x4C
	.DB  0x61,0x63,0x68,0x69,0x6E,0x61,0x6E,0x69
	.DB  0x20,0x20,0x0,0x30,0x30,0x3A,0x30,0x30
	.DB  0x3A,0x30,0x30,0x20,0x20,0x0,0x25,0x64
	.DB  0x3A,0x25,0x64,0x3A,0x25,0x64,0x20,0x20
	.DB  0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 009C lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 009D lcd_putsf("                 Yasin Lachinani  ");
	CALL SUBOPT_0x0
...
; 0000 00A3 lcd_clear();
	RCALL _lcd_clear
; 0000 00A4 delay_ms(0.01);
	CALL SUBOPT_0x1
; 0000 00A5 sprintf(str,"00:00:00  ");
	CALL SUBOPT_0x2
	__POINTW1FN _0x0,35
	ST   -Y,R31
	ST   -Y,R30
	...
	CALL _sprintf
	ADIW R28,4
; 0000 00A6 lcd_putsf("                 Yasin Lachinani  ");
	CALL SUBOPT_0x0
...
; 0000 00AD a=0;
	CLR  R4
	CLR  R5
; 0000 00AE sprintf(str,"%d:%d:%d   ",c,b,a);
	CALL SUBOPT_0x2
	CALL SUBOPT_0x3
; 0000 00AF lcd_gotoxy(0,0);
; 0000 00B0 lcd_puts(str);
; 0000 00B1 }
; 0000 00B2 
; 0000 00B3 
; 0000 00B4 if(Start==0){
_0x7:
	SBIC 0x19,0
	RJMP _0x8
; 0000 00B5 delay_ms(0.01);
	CALL SUBOPT_0x1
; 0000 00B6 a++;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
; 0000 00B7 sprintf(str,"%d:%d:%d   ",c,b,a);
	CALL SUBOPT_0x2
	CALL SUBOPT_0x3
