...
;#include <delay.h>
;
;#define key_t1  PINB.0
;#define key_t2  PINB.1
;#define key_t3  PINB.2
;#define key_t4  PINB.3
;#define key_t5  PINB.4
;#define sen_t1  PINA.0
;#define sen_t2  PINA.1
;#define sen_t3  PINA.2
;#define sen_t4  PINA.3
;#define sen_t5  PINA.4
;#define kab_t1  PIND.0
;#define kab_t2  PIND.1
;#define kab_t3  PIND.2
;#define kab_t4  PIND.3
;#define kab_t5  PIND.4
...
; 0000 001B DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 001C // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 001D PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(255)
	OUT  0x1B,R30
; 0000 001E 
...
; 0000 0021 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(0)
	OUT  0x17,R30
; 0000 0022 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
...
; 0000 0027 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(3)
	OUT  0x14,R30
; 0000 0028 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
...
; 0000 002F PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0030 
...
; 0000 0074 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0075 
...
_0xB:
	...
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0089         if(!sen_t2)y=2;
_0x17:
	SBIC 0x19,1
	RJMP _0x18
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 008A         if(!sen_t3)y=3;
_0x18:
	SBIC 0x19,2
	RJMP _0x19
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 008B         if(!sen_t4)y=4;
_0x19:
	SBIC 0x19,3
	RJMP _0x1A
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 008C         if(!sen_t5)y=5;
_0x1A:
	SBIC 0x19,4
	RJMP _0x1B
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 008D 
; 0000 008E         if(!kab_t1)x=1;
_0x1B:
	SBIC 0x10,0
	RJMP _0x1C
	LDI  R30,LOW(1)
	MOV  R4,R30
; 0000 008F         if(!kab_t2)x=2;
_0x1C:
	SBIC 0x10,1
	RJMP _0x1D
	LDI  R30,LOW(2)
	MOV  R4,R30
; 0000 0090         if(!kab_t3)x=3;
_0x1D:
	SBIC 0x10,2
	RJMP _0x1E
	LDI  R30,LOW(3)
	MOV  R4,R30
; 0000 0091         if(!kab_t4)x=4;
_0x1E:
	SBIC 0x10,3
	RJMP _0x1F
	LDI  R30,LOW(4)
	MOV  R4,R30
; 0000 0092         if(!kab_t5)x=5;
_0x1F:
	SBIC 0x10,4
	RJMP _0x20
	LDI  R30,LOW(5)
	MOV  R4,R30
; 0000 0093 
; 0000 0094         if(!key_t1)x=1;
_0x20:
	SBIC 0x16,0
	RJMP _0x21
	LDI  R30,LOW(1)
	MOV  R4,R30
; 0000 0095         if(!key_t2)x=2;
_0x21:
	SBIC 0x16,1
	RJMP _0x22
	LDI  R30,LOW(2)
	MOV  R4,R30
; 0000 0096         if(!key_t3)x=3;
_0x22:
	SBIC 0x16,2
	RJMP _0x23
	LDI  R30,LOW(3)
	MOV  R4,R30
; 0000 0097         if(!key_t4)x=4;
_0x23:
	SBIC 0x16,3
	RJMP _0x24
	LDI  R30,LOW(4)
	MOV  R4,R30
; 0000 0098         if(!key_t5)x=5;
_0x24:
	SBIC 0x16,4
	RJMP _0x25
	LDI  R30,LOW(5)
