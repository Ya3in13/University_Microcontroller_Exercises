...
; 0000 0003 interrupt [9] void timer1_ovf_isr(void){
...
; .FSTART _timer1_ovf_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0004     TCNT1=-1000;
	LDI  R30,LOW(64536)
	LDI  R31,HIGH(64536)
	OUT  0x2C+1,R31
	OUT  0x2C,R30
; 0000 0005     if(++cnt1>220){PORTD.0=!PORTD.0;cnt1=0;}
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
	CPI  R30,LOW(0xDD)
...
_0x5:
	CLR  R4
	CLR  R5
; 0000 0006     if(++cnt2>670){PORTD.1=!PORTD.1;cnt2=0;}
_0x3:
	MOVW R30,R6
	ADIW R30,1
	MOVW R6,R30
...
_0x8:
	CLR  R6
	CLR  R7
; 0000 0007     if(++cnt3>1600){PORTD.2=!PORTD.2;cnt3=0;}
_0x6:
	MOVW R30,R8
	ADIW R30,1
	MOVW R8,R30
...
; 0000 0038 // Timer Period: 65.536 ms
