...
; 0000 000B     // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 000C     DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 000D     // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 006F         while (1){
_0x3:
; 0000 0070          PORTA=0B00000001;delay_ms(100);
	RCALL SUBOPT_0x0
; 0000 0071          PORTA=0B00000010;delay_ms(100);
	RCALL SUBOPT_0x1
; 0000 0072          PORTA=0B00000100;delay_ms(100);
	RCALL SUBOPT_0x2
; 0000 0073          PORTA=0B00001000;delay_ms(100);
	RCALL SUBOPT_0x3
; 0000 0074          PORTA=0B00010000;delay_ms(100);
	RCALL SUBOPT_0x4
; 0000 0075          PORTA=0B00100000;delay_ms(100);
	RCALL SUBOPT_0x5
; 0000 0076          PORTA=0B01000000;delay_ms(100);
	RCALL SUBOPT_0x6
; 0000 0077          PORTA=0B10000000;delay_ms(100);
	RCALL SUBOPT_0x7
; 0000 0078          PORTA=0B00000000;delay_ms(100);
	RCALL SUBOPT_0x8
; 0000 0079 
; 0000 007A          PORTA=0B10000000;delay_ms(100);
	RCALL SUBOPT_0x7
; 0000 007B          PORTA=0B01000000;delay_ms(100);
	RCALL SUBOPT_0x6
; 0000 007C          PORTA=0B00100000;delay_ms(100);
	RCALL SUBOPT_0x5
; 0000 007D          PORTA=0B00010000;delay_ms(100);
	RCALL SUBOPT_0x4
; 0000 007E          PORTA=0B00001000;delay_ms(100);
	RCALL SUBOPT_0x3
; 0000 007F          PORTA=0B00000100;delay_ms(100);
	RCALL SUBOPT_0x2
; 0000 0080          PORTA=0B00000010;delay_ms(100);
	RCALL SUBOPT_0x1
; 0000 0081          PORTA=0B00000001;delay_ms(100);
	RCALL SUBOPT_0x0
; 0000 0082          PORTA=0B00000000;delay_ms(100);
	RCALL SUBOPT_0x8
; 0000 0083 
; 0000 0084          PORTA=0B10001000;delay_ms(100);
	RCALL SUBOPT_0x9
; 0000 0085          PORTA=0B00100010;delay_ms(100);
; 0000 0086          PORTA=0B01000100;delay_ms(100);
; 0000 0087          PORTA=0B00010001;delay_ms(100);
; 0000 0088          PORTA=0B10001000;delay_ms(100);
	RCALL SUBOPT_0x9
; 0000 0089          PORTA=0B00100010;delay_ms(100);
; 0000 008A          PORTA=0B01000100;delay_ms(100);
; 0000 008B          PORTA=0B00010001;delay_ms(100);
; 0000 008C 
; 0000 008D 
; 0000 008E         }
	RJMP _0x3
