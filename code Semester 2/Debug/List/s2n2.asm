...
; .FSTART _main
; 0000 0005 {
; 0000 0006 // Declare your local variables here
; 0000 0007 
; 0000 0008 // Input/Output Ports initialization
; 0000 0009 // Port A initialization
; 0000 000A // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 000B DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 000C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 000D PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	OUT  0x1B,R30
; 0000 000E 
; 0000 000F // Port B initialization
; 0000 0010 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0011 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0012 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0013 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0014 
...
; 0000 0017 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	OUT  0x14,R30
; 0000 0018 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0019 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 001A 
; 0000 001B // Port D initialization
; 0000 001C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 001D DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 001E // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 001F PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0020 
...
; 0000 0024 // Mode: Normal top=0xFF
; 0000 0025 // OC0 output: Disconnected
...
; 0000 002C // Clock value: Timer1 Stopped
...
; 0000 0031 // Input Capture on Falling Edge
; 0000 0032 // Timer1 Overflow Interrupt: Off
; 0000 0033 // Input Capture Interrupt: Off
...
; 0000 005B // The Analog Comparator's positive input is
; 0000 005C // connected to the AIN0 pin
; 0000 005D // The Analog Comparator's negative input is
; 0000 005E // connected to the AIN1 pin
...
; 0000 006C TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);              }
	OUT  0x36,R30
; 0000 006D 
; 0000 006E     while (1){
_0x3:
; 0000 006F         if(PIND.0 && PIND.1 && PIND.2 && PIND.3 && PIND.4 && PIND.5 && PIND.6 && PIND.7){
	SBIS 0x10,0
	RJMP _0x7
	SBIS 0x10,1
	RJMP _0x7
...
; 0000 0070         PORTC.0=1;
	SBI  0x15,0
; 0000 0071         }else if(!PIND.0 && !PIND.1 && !PIND.2 && !PIND.3 && !PIND.4 && !PIND.5 && !PIND.6 && !PIND.7){
	RJMP _0xB
_0x6:
	SBIC 0x10,0
	RJMP _0xD
...
; 0000 0072         PORTC.0=0;}
	CBI  0x15,0
; 0000 0073 
; 0000 0074     if(!PINB.0){PORTC.1=0;}
_0xC:
_0xB:
	SBIS 0x16,0
	CBI  0x15,1
; 0000 0075     if(!PINB.1){PORTC.1=1;}
	SBIS 0x16,1
	SBI  0x15,1
; 0000 0076     if(!PINB.2){PORTC.2=0;}
	SBIS 0x16,2
	CBI  0x15,2
; 0000 0077     if(!PINB.3){PORTC.2=1;}
	SBIS 0x16,3
	SBI  0x15,2
; 0000 0078     }
	RJMP _0x3
