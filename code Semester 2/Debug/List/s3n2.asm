...
;#include <delay.h>
;
;#define key_rast  PIND.3
;#define key_chap  PIND.2
;#define key_bala  PIND.0
;#define key_paen  PIND.1
;
;unsigned char g,x=0,y=0;
;
;void main(void) {
...
; 0000 0025 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0026 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0027 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(15)
	OUT  0x12,R30
; 0000 0028 
...
; 0000 0034 // Clock value: Timer1 Stopped
...
; 0000 003A // Timer1 Overflow Interrupt: Off
; 0000 003B // Input Capture Interrupt: Off
; 0000 003C // Compare A Match Interrupt: Off
; 0000 003D // Compare B Match Interrupt: Off
...
; 0000 0047 OCR1BL=0x00;
	OUT  0x28,R30
; 0000 0048 
; 0000 0049 // Timer/Counter 2 initialization
; 0000 004A // Clock source: System Clock
; 0000 004B // Clock value: Timer2 Stopped
; 0000 004C // Mode: Normal top=0xFF
; 0000 004D // OC2 output: Disconnected
; 0000 004E ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 004F TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (0<<CTC2) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0054 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0055 
...
; 0000 005E // USART disabled
; 0000 005F UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	OUT  0xA,R30
; 0000 0060 
; 0000 0061 // Analog Comparator initialization
; 0000 0062 // Analog Comparator: Off
; 0000 0063 // The Analog Comparator's positive input is
; 0000 0064 // connected to the AIN0 pin
; 0000 0065 // The Analog Comparator's negative input is
; 0000 0066 // connected to the AIN1 pin
; 0000 0067 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0068 SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0069 
; 0000 006A // ADC initialization
; 0000 006B // ADC disabled
; 0000 006C ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 006D 
; 0000 006E // SPI initialization
; 0000 006F // SPI disabled
; 0000 0070 SPCR=(0<<SPIE) | (0<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	OUT  0xD,R30
; 0000 0071 
; 0000 0072 // TWI initialization
; 0000 0073 // TWI disabled
; 0000 0074 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0075 
...
; 0000 0079 // RS - PORTA Bit 0
; 0000 007A // RD - PORTA Bit 1
; 0000 007B // EN - PORTA Bit 2
; 0000 007C // D4 - PORTA Bit 4
; 0000 007D // D5 - PORTA Bit 5
; 0000 007E // D6 - PORTA Bit 6
; 0000 007F // D7 - PORTA Bit 7
; 0000 0080 // Characters/line: 20
; 0000 0081 lcd_init(20);           }
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0082 
; 0000 0083     while(1){
_0x3:
; 0000 0084         if(!key_rast)g=1;
	SBIC 0x10,3
	RJMP _0x6
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0085         if(!key_chap)g=2;
_0x6:
	SBIC 0x10,2
	RJMP _0x7
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 0086         if(!key_bala)g=3;
_0x7:
	SBIC 0x10,0
	RJMP _0x8
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 0087         if(!key_paen)g=4;
_0x8:
	SBIC 0x10,1
	RJMP _0x9
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 0088 
; 0000 0089         if(g==1){if(x==19)x=0; else x++;}
_0x9:
	LDI  R30,LOW(1)
	CP   R30,R5
	BRNE _0xA
...
_0xB:
	INC  R4
_0xC:
; 0000 008A         if(g==2){if(x==0)x=19; else x--;};
_0xA:
	LDI  R30,LOW(2)
	CP   R30,R5
	BRNE _0xD
...
_0xF:
_0xD:
; 0000 008B         if(g==3){if(y==0)y=1; else y--;};
	LDI  R30,LOW(3)
	CP   R30,R5
	BRNE _0x10
	TST  R7
...
_0x12:
_0x10:
; 0000 008C         if(g==4){if(y==1)y=0; else y++;};
	LDI  R30,LOW(4)
	CP   R30,R5
	BRNE _0x13
	LDI  R30,LOW(1)
