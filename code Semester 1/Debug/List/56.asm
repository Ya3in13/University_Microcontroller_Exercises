...
_0x3:
; 0000 0087       {
; 0000 0088                  if(PINA.0==0) {
	SBIC 0x19,0
	RJMP _0x6
; 0000 0089                  PORTC=0b01100110;}
	LDI  R30,LOW(102)
	RJMP _0xF
; 0000 008A 
; 0000 008B 
; 0000 008C                  else if(PINA.1==0) {
_0x6:
	SBIC 0x19,1
	RJMP _0x8
; 0000 008D                  PORTC=0b01111111;}
	LDI  R30,LOW(127)
	RJMP _0xF
; 0000 008E 
; 0000 008F 
; 0000 0090                  else if(PINA.2==0) {
_0x8:
	SBIC 0x19,2
	RJMP _0xA
; 0000 0091                  PORTC=0b00100111;}
	LDI  R30,LOW(39)
	RJMP _0xF
; 0000 0092 
; 0000 0093 
; 0000 0094                  else if(PINA.3==0) {
_0xA:
	SBIC 0x19,3
	RJMP _0xC
; 0000 0095                  PORTC=0b01100110;}
	LDI  R30,LOW(102)
	RJMP _0xF
; 0000 0096                  else PORTC=0b0111111;
_0xC:
	LDI  R30,LOW(63)
_0xF:
	OUT  0x15,R30
