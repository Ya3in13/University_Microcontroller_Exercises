...
; 0000 0023 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 0024 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0025 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(15)
	OUT  0x1B,R30
; 0000 0026 
...
_0x3:
; 0000 0089       {
; 0000 008A                  if(PINA.0==0) {
	SBIC 0x19,0
	RJMP _0x6
; 0000 008B                  PORTC=0b01001111;}
	LDI  R30,LOW(79)
	RJMP _0xF
; 0000 008C 
; 0000 008D 
; 0000 008E                  else if(PINA.1==0) {                      // 0b01001111       0b01011011     0b01111101
_0x6:
	SBIC 0x19,1
	RJMP _0x8
; 0000 008F                  PORTC=0b01011011;}
	LDI  R30,LOW(91)
	RJMP _0xF
; 0000 0090 
; 0000 0091 
; 0000 0092                  else if(PINA.2==0) {
_0x8:
	SBIC 0x19,2
	RJMP _0xA
; 0000 0093                  PORTC=0b01111101;}
	LDI  R30,LOW(125)
	RJMP _0xF
; 0000 0094 
; 0000 0095 
; 0000 0096                  else if(PINA.3==0) {
_0xA:
	SBIC 0x19,3
	RJMP _0xC
; 0000 0097                  PORTC=0b01111101;}
	LDI  R30,LOW(125)
	RJMP _0xF
; 0000 0098                  else PORTC=0b0000000;
_0xC:
	LDI  R30,LOW(0)
_0xF:
	OUT  0x15,R30
