...
_0x0:
	.DB  0x20,0x59,0x61,0x73,0x69,0x6E,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x31,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x32,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x33,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x34,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x35,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x36,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x37,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x38,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x39,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x2A,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x30,0x20,0x20,0x0
	.DB  0x20,0x20,0x20,0x20,0x23,0x20,0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0031 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0032 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(240)
	OUT  0x14,R30
; 0000 0033 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=P Bit2=P Bit1=P Bit0=P
...
; 0000 0094 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0095 lcd_gotoxy(1,1); lcd_putsf(" Yasin ");
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
...
; 0000 009C       PORTC.7=1;
	SBI  0x15,7
; 0000 009D       if( PINC.2==0){ lcd_gotoxy(0,0); lcd_putsf("    1  "); }
	SBIC 0x13,2
	RJMP _0xE
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,8
	RCALL _lcd_putsf
; 0000 009E       if( PINC.1==0){ lcd_gotoxy(0,0); lcd_putsf("    2  ");}
_0xE:
	SBIC 0x13,1
	RJMP _0xF
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,16
	RCALL _lcd_putsf
; 0000 009F       if( PINC.0==0){ lcd_gotoxy(0,0); lcd_putsf("    3  "); }
_0xF:
	SBIC 0x13,0
	RJMP _0x10
	CALL SUBOPT_0x0
...
; 0000 00A4       PORTC.7=1;
	SBI  0x15,7
; 0000 00A5       if( PINC.2==0){ lcd_gotoxy(0,0); lcd_putsf("    4  "); }
	SBIC 0x13,2
	RJMP _0x19
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,32
	RCALL _lcd_putsf
; 0000 00A6       if( PINC.1==0){ lcd_gotoxy(0,0); lcd_putsf("    5  ");}
_0x19:
	SBIC 0x13,1
	RJMP _0x1A
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,40
	RCALL _lcd_putsf
; 0000 00A7       if( PINC.0==0){ lcd_gotoxy(0,0); lcd_putsf("    6  "); }
_0x1A:
	SBIC 0x13,0
	RJMP _0x1B
	CALL SUBOPT_0x0
...
; 0000 00AC       PORTC.7=1;
	SBI  0x15,7
; 0000 00AD       if( PINC.2==0){ lcd_gotoxy(0,0); lcd_putsf("    7  "); }
	SBIC 0x13,2
	RJMP _0x24
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,56
	RCALL _lcd_putsf
; 0000 00AE       if( PINC.1==0){ lcd_gotoxy(0,0); lcd_putsf("    8  ");}
_0x24:
	SBIC 0x13,1
	RJMP _0x25
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,64
	RCALL _lcd_putsf
; 0000 00AF       if( PINC.0==0){ lcd_gotoxy(0,0); lcd_putsf("    9  "); }
_0x25:
	SBIC 0x13,0
	RJMP _0x26
	CALL SUBOPT_0x0
...
; 0000 00B4       PORTC.7=0;
	CBI  0x15,7
; 0000 00B5       if( PINC.2==0){ lcd_gotoxy(0,0); lcd_putsf("    *  "); }
	SBIC 0x13,2
	RJMP _0x2F
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,80
	RCALL _lcd_putsf
; 0000 00B6       if( PINC.1==0){ lcd_gotoxy(0,0); lcd_putsf("    0  ");}
_0x2F:
	SBIC 0x13,1
	RJMP _0x30
	CALL SUBOPT_0x0
	__POINTW2FN _0x0,88
	RCALL _lcd_putsf
; 0000 00B7       if( PINC.0==0){ lcd_gotoxy(0,0); lcd_putsf("    #  "); }
_0x30:
	SBIC 0x13,0
	RJMP _0x31
	CALL SUBOPT_0x0
